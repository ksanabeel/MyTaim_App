...
export default function ProfileSettings({ session, onUpdate }) {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (profileData) {
        ...
        setThemeColor(profileData.theme_color || "#7c3aed");
        setProviderType(profileData.provider_type || "individual");
        setMaxCapacity(profileData.max_concurrent_bookings || 1);
        setPhone(profileData.phone || "");
        setUsername(profileData.username || "");
        setOriginalUsername(profileData.username || "");
        setMarketingSource(profileData.marketing_source || "");
        setReferredBy(profileData.referred_by || "");
        ...
        setIs24x7(profileData.is_24_7 !== false);
        setWorkStart(profileData.work_start_time?.substring(0, 5) || "08:00");
        setWorkEnd(profileData.work_end_time?.substring(0, 5) || "22:00");
        setTaxNumber(profileData.tax_number || "");
        setLicenseInfo(profileData.license_info || "");
        setAdminNote(profileData.admin_note || "");
        setProviderNote(profileData.provider_note || "");
      ...
      // 2. ✨ جلب رابط لوجو المنصة من الإعدادات ✨
  ...
  // ✨ استخدام لوجو المنصة (إن وجد) وإلا استخدام الحروف الملونة ✨
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input
                ...
                style={{
                  ...inpS,
                  paddingRight: isRTL ? "35px" : "15px",
                  paddingLeft: isRTL ? "15px" : "35px",
                  borderColor:
                    usernameStatus === "taken" ||
                    usernameStatus === "invalid" ||
                    usernameStatus === "too_short"
          ...
          >
            ...
            <button
              ...
              style={{
                marginTop: "20px",
                backgroundColor:
                  isDeletingAccount || isSubmitting ? "#cbd5e1" : "#dc2626",
                color: "white",
                border: "none",
                padding: "14px 24px",
                borderRadius: "10px",
